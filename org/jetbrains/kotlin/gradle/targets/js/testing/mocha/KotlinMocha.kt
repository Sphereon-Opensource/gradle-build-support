...
class KotlinMocha internal constructor(
    ...
    override fun createTestExecutionSpec(
        ...
        val args = nodeJsArgs + mutableListOf(
            ...
            // Force exit after tests complete even if event loop has active handles
            // (DI graphs, HTTP clients, coroutine dispatchers keep Node.js alive otherwise)
            add(EXIT_ARG)
        }
...
private const val EXIT_ARG = "--exit"
