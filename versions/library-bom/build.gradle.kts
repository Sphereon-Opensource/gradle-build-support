...
//        api("software.amazon.lastmile.kotlin.inject.anvil:compiler:0.1.7")
        api("software.amazon.app.platform:metro-public:0.0.15SPH-SNAPSHOT")
        api("software.amazon.app.platform:metro-impl:0.0.15SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-public:0.0.15SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-impl:0.0.15SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-contribute-public:0.0.15SPH-SNAPSHOT")
        api("software.amazon.app.platform:scope-public:0.0.15SPH-SNAPSHOT")
        ...
        api("io.ktor:ktor-client-core-jvm:3.5.0")
        api("io.ktor:ktor-client-core-js:3.5.0")
        api("io.ktor:ktor-client-core-wasm-js:3.5.0")
        api("io.ktor:ktor-client-cio:3.5.0")
        api("io.ktor:ktor-client-cio-jvm:3.5.0")
        api("io.ktor:ktor-client-cio-js:3.5.0")
        api("io.ktor:ktor-client-cio-wasm-js:3.5.0")
        api("io.ktor:ktor-client-okhttp:3.5.0")
        api("io.ktor:ktor-client-okhttp-jvm:3.5.0")
        api("io.ktor:ktor-client-darwin:3.5.0")
        api("io.ktor:ktor-client-js:3.5.0")
        api("io.ktor:ktor-client-js-wasm-js:3.5.0")
        api("io.ktor:ktor-client-java:3.5.0")
        api("io.ktor:ktor-client-logging:3.5.0")
        api("io.ktor:ktor-client-mock:3.5.0")
        api("io.ktor:ktor-client-mock-js:3.5.0")
        api("io.ktor:ktor-client-auth:3.5.0")
        api("io.ktor:ktor-client-content-negotiation:3.5.0")
        api("io.ktor:ktor-client-serialization:3.5.0")
        api("io.ktor:ktor-io:3.5.0")
        api("io.ktor:ktor-server-core:3.5.0")
        api("io.ktor:ktor-server-cio:3.5.0")
        api("io.ktor:ktor-server-netty:3.5.0")
        api("io.ktor:ktor-server-jetty:3.5.0")
        api("io.ktor:ktor-server-content-negotiation:3.5.0")
        api("io.ktor:ktor-serialization-kotlinx-json:3.5.0")
        api("io.ktor:ktor-server-test-host:3.5.0")
        api("io.ktor:ktor-serialization-kotlinx-cbor:3.5.0")
        api("io.ktor:ktor-serialization-kotlinx-protobuf:3.5.0")
        api("io.ktor:ktor-server-auth:3.5.0")
        api("io.ktor:ktor-server-auth-jwt:3.5.0")
        api("io.ktor:ktor-server-status-pages:3.5.0")
        api("io.ktor:ktor-server-cors:3.5.0")
        api("io.ktor:ktor-server-call-logging:3.5.0")
        ...
        api("co.touchlab.skie:configuration-annotations:0.10.12")
