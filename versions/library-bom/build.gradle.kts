...
dependencies {
    constraints {
        ...
        api("software.amazon.app.platform:metro-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:metro-impl:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-impl:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-contribute-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:scope-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:di-common-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:presenter-molecule-impl:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:presenter-molecule-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:renderer-compose-multiplatform-public:0.0.11SPH-SNAPSHOT")
        api("software.amazon.app.platform:kotlin-inject-contribute-impl-code-generators:0.0.11SPH-SNAPSHOT")
